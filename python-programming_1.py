...
# Then convert those steps into the language being Python in this situtation

# Every language has the folowing
...
# Ask the user to iinput their name and assing it to the name variable
...
# Print out Hello folloewed by the name they entered
print('Hello ', name)

# You cannot use the following for variable names
# and, del, from, not, while, as, elif, global,
# or, with, assert, else, if, pass, yieeld, break,
# except, import, print, class, exec, in, raise,
# continue, finally, is, return, def, for, lambda,
# try

# Single line comments are ignoresd by the interpeter
'''
So are multiline commnets
'''
...
# Convert strings into regular numbes (integers)
num1 = int(num1)
num2 = int(num2)
...
# Subtract the values and store in sum
...
# --------------PROBLEM : MILES TO KILOMETRES -------------
# Sample knowing that kilometers = miles * 1.60934
# Enter Miles 5
# 5 miles equals 8.0467 kilometers

# Ask the user to input miles and assing it to the miles variable
...
#- ---------------CALCULATOR ----------
# Receive 2 numbers seperated by an operator and show a result
# Sample
...
# not : Converts true inot false and vice versa
